...
| 2025-10-22 | Enforced sheet schema bootstrap and added repositories for `_meta`, `categories`, `accounts`, `budget_plan`, `snapshots`, and `actuals` | Guarantees spreadsheet structure and provides typed accessors for Milestone 1 workflows |
